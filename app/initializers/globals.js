/**
* Injects variables that should be accessible throughout the app into routes, controllers, components and models
*
* Variables injected (from the environment.js file):
* apiUrl
* cableUrl
* appEnvironment
* appVersion
* enabledModules
*
* Also Injects jobtitles, locations, specialties variables. These should be loaded once on hitting the app.main route (i.e. when logged in).
*
* Injects unread-alerts, to hold alert counts across the app.
*
* @module AppCore
* @class initializers-globals
**/
...
export function initialize(application) {
  ...
  var jts = Ember.Object.create();
  jts.set('all', Ember.A());
  var specs = Ember.Object.create();
  specs.set('all', Ember.A());
  var locs = Ember.Object.create();
  locs.set('all', Ember.A());
  ...
  application.register('oslrglobals:unread-alerts', Ember.Object.create(), { instantiate: false });
  application.register('oslrglobals:alerts-subscription', Ember.Object.create(), { instantiate: false });
